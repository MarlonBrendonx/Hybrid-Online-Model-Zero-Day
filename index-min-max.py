...
# ─────────────────────────────────────────────
#  Utilidade de log com timestamp
# ─────────────────────────────────────────────
...
def run_experiment(
    ...
    # ── 4. Warm-up do HST com amostras normais ────────────────────────────
    ...
    # ── 5. Scores de treino para calibrar limiar do HST ───────────────────
    ...
    # ── 6. Treino incremental do clf + OSR ────────────────────────────────
    ...
    LOG_STEPS = max(1, n_total // 5)  # log a cada 20 % do progresso
